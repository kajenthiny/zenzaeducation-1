    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <section className="relative w-full min-h-[70vh] sm:min-h-[75vh] md:min-h-screen bg-gradient-to-br from-[#031d91] via-[#0425b5] to-[#052ec9] overflow-hidden flex items-center">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          {/* Graduation cap icon - Now visible on all screens */}
          <div className="absolute top-16 right-[8%] sm:top-20 sm:right-[10%] md:top-28 md:left-[45%] md:right-auto lg:top-30 lg:left-[58%] animate-float">
            <svg
              className="w-10 h-10 sm:w-12 sm:h-12 md:w-12 md:h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16 text-white/20"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        {/* Diagonal / Rhombus shape - Hidden on mobile only */}
        <img
          src={rhombus}
          alt="bg-shape"
          className="hidden sm:block absolute right-[-100px] lg:right-[-140px] xl:right-[-160px] bottom-0 h-full object-contain z-0"
        />

        {/* Hero image - Hidden on mobile only */}
        <img
          src={heroImage}
          alt="Hero"
          className="hidden sm:block absolute bottom-0 right-0 h-[60%] md:h-[75%] lg:h-[85%] xl:h-[90%] object-contain z-10"
        />

        {/* CONTENT WRAPPER */}
        <div className="relative z-20 w-full px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 py-8 sm:py-10 md:py-12">
          <div className="max-w-full sm:max-w-xl md:max-w-2xl text-white">

            {/* BADGE */}
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-3 sm:px-4 py-1.5 mb-4 sm:mb-5">
              <span className="text-xs sm:text-sm font-medium">
                Trusted by 10,000+ Students
              </span>
            </div>

            {/* FLAGS - Hidden on mobile only */}
            <div className="hidden sm:flex flex-wrap gap-3 lg:gap-4 xl:gap-6 mb-6 lg:mb-8">
              {[d1, d2, d3, d4].map((img, idx) => (
                <img
                  key={idx}
                  src={img}
                  alt={`Destination ${idx + 1}`}
                  className="h-[60px] w-[100px] md:h-[80px] md:w-[130px] lg:h-[100px] lg:w-[160px] xl:h-[120px] xl:w-[200px] rounded-lg xl:rounded-xl object-cover shadow-2xl hover:scale-105 transition-all duration-300"
                />
              ))}
            </div>

            {/* TEXT */}
            <h1 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold mb-3 sm:mb-4 leading-tight">
            ...
            <p className="text-sm sm:text-base md:text-base lg:text-lg xl:text-xl text-blue-100 mb-6 sm:mb-7 md:mb-8 max-w-lg leading-relaxed">
              Explore Global Destinations, Unlock Academic Success, and Shape Your Future With Us.
            </p>

            {/* STATS */}
            <div className="grid grid-cols-3 gap-3 sm:gap-4 md:gap-5 lg:gap-6 mb-6 sm:mb-7 md:mb-8">
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-3 sm:p-3.5 lg:p-4 border border-white/10 hover:bg-white/10 transition text-center md:text-left">
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-yellow-300">50+</p>
                <p className="text-[10px] sm:text-xs lg:text-sm text-blue-200 mt-0.5">Universities</p>
              </div>

              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-3 sm:p-3.5 lg:p-4 border border-white/10 hover:bg-white/10 transition text-center md:text-left">
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-300">95%</p>
                <p className="text-[10px] sm:text-xs lg:text-sm text-blue-200 mt-0.5">Success Rate</p>
              </div>

              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-3 sm:p-3.5 lg:p-4 border border-white/10 hover:bg-white/10 transition text-center md:text-left">
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-pink-300">25+</p>
                <p className="text-[10px] sm:text-xs lg:text-sm text-blue-200 mt-0.5">Countries</p>
              </div>
            </div>

            {/* CTA */}
            <button className="bg-white text-[#031d91] font-semibold py-3 sm:py-3 px-6 sm:px-8 rounded-full shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 w-full sm:w-auto flex items-center justify-center gap-2 text-sm sm:text-base">
              Get Started
              <svg
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <h2 className={`text-4xl md:text-5xl font-bold text-gray-900 mb-4 text-center transition-all duration-1000 ${isVisible.testimonials ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            Trusted by <span className="text-blue-600 animate-gradient">100s of Students!</span>
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-10">
            {currentImages.map((img, index) => (
              <div
                ...
                className={`relative overflow-hidden rounded-3xl bg-white shadow-xl hover:shadow-2xl transition-all duration-500 group cursor-pointer border-2 border-gray-200 hover:border-slate-400 ${isVisible.testimonials ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
                style={{
    ...
    <button className="w-[150px] bg-gradient-to-r from-blue-600 to-blue-800 text-white font-semibold py-2.5 rounded-xl 
      ...
      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          ...
          <div
            className={`transition-all duration-700 ${isVisible.testimonials
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center relative z-10">
                ...
                <div className="group">
                  <div className="flex justify-center mb-5">
                    <div className="p-5 bg-white/20 backdrop-blur-md rounded-full shadow-lg group-hover:scale-110 transition-all duration-300">
                  ...
                  <h3 className="text-5xl font-extrabold text-white mb-1 tracking-tight">
                    500<span className="text-cyan-300">+</span>
                  </h3>
                ...
                <div className="group">
                  ...
                  <h3 className="text-5xl font-extrabold text-white mb-1 tracking-tight">
                    300<span className="text-purple-300">+</span>
                  </h3>
                  <p className="text-white/80 tracking-wide uppercase text-sm">
                    Students Placed
                  </p>
      ...
      >
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <div className={`text-center mb-16 transition-all duration-1000 ${isVisible.destinations ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight text-center">
                ...
                <div className="bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden h-full flex flex-col hover:-translate-y-3 relative">
                  ...
                  <div className="p-8 text-center flex flex-col flex-grow relative">
                    ...
                    <div className="flex justify-center mt-auto">
                      <button className="group/btn relative w-14 h-14 rounded-full bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg hover:shadow-2xl hover:shadow-blue-500/50 hover:scale-110 transition-all duration-300 flex items-center justify-center overflow-hidden">
                        <svg className="w-6 h-6 group-hover/btn:translate-x-1 transition-transform duration-300 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
