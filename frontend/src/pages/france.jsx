  ...
  const cards = [
    {
      ...
      desc: `A world-renowned university in Paris, known for excellence in Arts, Humanities, Science, and Research. A top destination for international students.`,
      big: uni1,
      small1: uni2,
      small2: uni3,
      reverse: false,
    },
    {
      ...
      desc: `One of France’s highest-ranked research universities. Strong in Engineering, Computer Science, Mathematics, and Physics with excellent industry connections.`,
      big: uni4,
      small1: uni5,
      small2: uni6,
      reverse: true,
    ...
    {
      id: 3,
      title: "ÉCOLE POLYTECHNIQUE (INSTITUT POLYTECHNIQUE DE PARIS)",
      desc: `A prestigious engineering school in France, highly respected for Technology, AI, Data Science, Innovation, and advanced Engineering programs.`,
      big: uni7,
      small1: uni8,
      small2: uni9,
      reverse: false,
    ...
    {
      id: 4,
      title: "UNIVERSITY GRENOBLE ALPES",
      desc: `A leading public university known for Engineering, Environmental Science, and Computer Science. Located in a student-friendly city with strong research output.`,
      big: uni10,
      small1: uni11,
      small2: uni12,
      reverse: true,
    },
    {
      ...
      desc: `A major French university with strong programs in Medicine, Life Sciences, Law, and International Studies. Offers a rich European academic environment.`,
      big: uni13,
      small1: uni14,
      small2: uni15,
      reverse: false,
    },
    {
      ...
      desc: `One of France’s top business schools, well known for MBA, Management, Marketing, and Entrepreneurship programs with strong global networking and career support.`,
      big: uni16,
      small1: uni17,
      small2: uni18,
      reverse: true,
