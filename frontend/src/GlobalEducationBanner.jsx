  ...
  -translate-y-20 sm:-translate-y-16 md:translate-y-0">
    ...
    <div className="max-w-full sm:max-w-xl md:max-w-2xl text-white">
     ...
     <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4 lg:gap-6 mb-4 sm:mb-6 md:mb-8 lg:mb-10">
      ...
      {/* CTA Button */}
      <button className="bg-white text-[#031d91] font-semibold py-2 px-5 sm:py-2.5 sm:px-6 md:py-3 md:px-8 rounded-full shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm md:text-base w-full sm:w-auto justify-center">
        Get Started
